...
if __name__ == "__main__":
    ...
    for bfn in bfns:
        ...
        try:
            cmd = "solve-field " + root + source + bfn + ".fits --use-sextractor --no-plots --scale-units arcminwidth --scale-low 20 --scale-high 22 --continue --skip-solved --parity neg --no-tweak --depth 15,30,45 --cpulimit 30 -D " + root + dest + outputDir + " --new-fits " + root + dest + bfn + ".fits"
        except e:
            print(e)
