...
def phot(fn, outFn):
    ...
    cooFile = fn + ".coo"
    iraf.phot(fn, coords =  cooFile, output = outFn, interac = "no", verify = "no", Stdout=1,
            exposur = "EXPTIME", airmass = "AIRMASS", filter = "FILTER", apertur = "5, 10, 15, 20, 25, 30", annulus = 40,
            dannulus = 5, obstime = "DATE-OBS")
